...
//   for (const allCells of cell) {
//     allCells.classList.remove('x');
//     allCells.classList.remove('o');
//     allCells.classList.remove('won');
//   }
//   gameIsLive = true;
...
//   if (!gameIsLive || classList[3] === 'x' || classList[1] === '3') {   // x or o. Not both or multiple
//     return;
//   }
...
//     // Check diagonally /
//     winningCells = [cell];
//     rowToCheck = rowIndex + 1;                                        // opposite of each other                
//     colToCheck = colIndex - 1;
